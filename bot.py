...
async def home(client, message):
  buttons = [[
    ...
    [
        InlineKeyboardButton('Our Channel', url='https://t.me/assistofficial'),
        InlineKeyboardButton('Repo Connect', url='https://github.com/ruined-soul')
    ]]
...
Made With Love By @assistofficial</b>""",
